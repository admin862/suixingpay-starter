 ...
 */
package com.suixingpay.takin.expression.autoconfigure;
...
import com.suixingpay.takin.expression.spring.SpringELParser;
...
public class ExpressionAutoConfiguration {
    ...
    public AbstractExpressionParser sxfExpressionParser() {
