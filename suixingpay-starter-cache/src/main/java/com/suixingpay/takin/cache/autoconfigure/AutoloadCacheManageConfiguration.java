...
import com.suixingpay.takin.cache.redis.SpringJedisCacheManager;
...
@ConditionalOnProperty(value = "suixingpay.autoload.cache.enable", matchIfMissing = true)
public class AutoloadCacheManageConfiguration {
    ...
    public AbstractScriptParser autoloadCacheScriptParser() {
        AbstractScriptParser res = new SpringELParser();
