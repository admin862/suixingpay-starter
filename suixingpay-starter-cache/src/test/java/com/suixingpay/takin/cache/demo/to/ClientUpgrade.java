 ...
 * @date: 2017年10月31日 下午1:35:25
 * @version: V1.0
 * @review: qiujiayu[qiu_jy@suixingpay.com]/2017年10月31日 下午1:35:25
 */
public class ClientUpgrade implements Cloneable, Serializable {
    ...
    public String toString() {
        return "ClientUpgrade [id=" + id + ", os=" + os + ", packageName=" + packageName + ", versionCode="
                + versionCode + ", versionName=" + versionName + ", downloadUrl=" + downloadUrl + ", forceUpgrade="
                + forceUpgrade + ", changeLog=" + changeLog + "]";
    }
