 ...
 */
package com.suixingpay.takin.util.number;
...
import com.suixingpay.takin.util.base.ValidateMore;
...
public abstract class RandomUtils {
     ...
     * JDK本身不具有控制两端范围的nextInt，因此参考Commons Lang RandomUtils的实现, 不直接复用是因为要传入Random实例 see
